...
<script>
  ...
  import { uploadDirectChangeExcel } from '@/api/uploadExcel'
  ...
  export default {
    ...
    data() {
      return {
        ...
        pos: null,
         errorFlag: false,
        downloadUrl: 'static/excel/直属变更.xlsx'
      }
    },
    methods: {
      showDialog() {
      ...
      selected(data) {
        ...
        const kepMap = {
          '行号': 'lineNo',
          '员工工号': 'userEmpNo',
          '所在城市变更时间': 'cityChangeDate',
          '所在城市': 'city',
          '物理职场变更时间': 'workplaceChangeDate',
          '物理职场': 'workplace',
          '直属上级变更时间': 'supervisorChangeDate',
          '直属上级工号': 'directSupervisorEmpNo',
          '合伙人变更时间': 'partnerChangeDate',
          '合伙人工号': 'partnerEmpNo',
          '区域总变更时间': 'regionalManagerChangeDate',
          '区域总工号': 'regionalManagerEmpNo',
          '区域副总变更时间': 'regionalViceManagerChangeDate',
          '区域副总工号': 'regionalViceManagerEmpNo',
          '城市总变更时间': 'cityManagerChangeDate',
          '城市总工号': 'cityManagerEmpNo',
          '城市副总变更时间': 'cityViceManagerChangeDate',
          '城市副总工号': 'cityViceManagerEmpNo',
          '团队经理变更时间': 'teamManagerChangeDate',
          '团队经理工号': 'teamManagerEmpNo',
          '公司变更时间': 'companyChangeDate',
          '公司': 'companyName',
          '区域变更时间': 'regionalChangeDate',
          '区域': 'regional',
          '部门变更时间': 'deptChangeDate',
          '部门': 'deptName',
          '职位变更时间': 'positionChangeDate',
          '职位': 'positionName',
          '职级变更时间': 'rankChangeDate',
          '职级': 'rankName',
        }
      ...
      submit() {
        uploadDirectChangeExcel(this.formData).then(res => {
          if (res.status === 200) {
